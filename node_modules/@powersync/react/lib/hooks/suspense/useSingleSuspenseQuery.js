 ...
 */
export const useSingleSuspenseQuery = (query, parameters = [], options = {}) => {
    ...
    const watchedQuery = data ? null : store.getQuery(key, parsedQuery, options);
...
//# sourceMappingURL=useSingleSuspenseQuery.js.map