 ...
 */
export const useTemporaryHold = (watchedQuery) => {
    const releaseTemporaryHold = React.useRef(undefined);
    const addedHoldTo = React.useRef(undefined);
 ...
 */
export const createSuspendingPromise = (query) => {
...
//# sourceMappingURL=suspense-utils.js.map